...
void main() async {
  try {
    ...
    if (await Permission.microphone.isGranted && crisisDetect) {
  ...
  void _setCrisisDetectionEnabled(bool value) async {
    if (await Permission.microphone.isGranted) {
      ...
      if (value)
        ...
        await AudioClassification.instance.turnOff();
      setState(() {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(
                "Crisis detection only works with the microphone enabled. Please enable microphone access in your settings."),
            actions: <Widget>[
              TextButton(
                child: Text("OK"),
                onPressed: () {
