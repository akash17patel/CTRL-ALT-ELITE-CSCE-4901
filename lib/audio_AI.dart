...
class _AudioClassificationScreenState extends State<AudioClassificationScreen> {
  ...
  // Platform channel
  static const MethodChannel channel = MethodChannel('com.example.mindlift_flutter/audio_AI');
  ...
  Future<Float32List> _getAudioFloatArray() async {
    try {
      final List? result = await channel.invokeMethod<List<dynamic>>('wavToFloatArray', {'filePath': path});
